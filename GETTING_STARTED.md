...
1. **`pubspec.yaml`**:
   ```yaml
   name: your_app_name  # Change from party_pocket
...
Ask your AI agent:
```
Please rename this Flutter app from "party_pocket" to "my_awesome_app" 
and update the package name from "com.cmwen.party_pocket" to "com.mycompany.my_awesome_app". 
