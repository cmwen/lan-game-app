...
**CRITICAL**: Before running your app, you MUST update the package name from the template default `com.cmwen.party_pocket` to your own package name. Failure to do so will cause app launch issues.
...
#### File: `android/app/src/main/kotlin/com/cmwen/party_pocket/MainActivity.kt`
...
mv com/cmwen/party_pocket/MainActivity.kt com/yourcompany/yourapp/
...
```
@flutter-developer Please rename this Flutter app from "party_pocket" to "my_awesome_app" 
and update the package from "com.cmwen.party_pocket" to "com.mycompany.my_awesome_app".
